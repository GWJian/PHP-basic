...
case 'Book':
echo "Book: " . $product->getName() . " by " . $product->getAuthor() . " - $" . $product->getPrice() . " (" .
$product->getQuantity() . " in stock) - ISBN: " . $product->getISBN() . "<br />";
break;
case 'Clothing':
echo "Clothing: " . $product->getName() . " - $" . $product->getPrice() . " (" . $product->getQuantity() . " in stock) -
Size: " . $product->getSize() . " - Color: " . $product->getColor() . "<br />";
break;
}
}